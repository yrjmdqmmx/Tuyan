...
40 个目标模型的既有产物重评、独立仲裁及正式发布已完成。686 份双审、206 题第三方仲裁与 47 模型 / 423 题公开验收通过；7 个保留模型的原评分、评语、图片和费用不变，新增生图调用为 0。正式版本 `bench-scientific-v2-release-8e6619b57c6979d9c568`。逐模型新旧得分、名次、变化原因与审计证据见 [完成报告](releases/2026-09-17-scientific-v2-rereview.md)。
