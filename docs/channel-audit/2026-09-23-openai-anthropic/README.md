...
核查日：2026-09-23。实现基线 `54c90ad`，目录 `2026-09-23.v25`。后续经用户授权，Web / Core 已随 PR #230 / `9a52aa7` 上线并追加到 Tuyan v3.8.0；实际部署与只读线上验收见[本次发布记录](../../releases/2026-09-23-tuyan-v3.8.0-model-update.md)。下文及本地验收记录中的模拟结果不代表真实推理；未充值、未调用付费推理、未重跑历史任务，账号权限与账单仍未验证。
