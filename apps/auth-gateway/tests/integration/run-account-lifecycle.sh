...
container="tuyan-account-lifecycle-test-$$-${RANDOM}"
...
ACCOUNT_LIFECYCLE_TEST_MONGO_URI="mongodb://127.0.0.1:${port}/?directConnection=true" node "$repo_dir/apps/auth-gateway/tests/integration/account-lifecycle.mjs"
