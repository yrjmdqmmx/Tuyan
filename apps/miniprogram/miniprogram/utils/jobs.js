...
function normalizeJob(input) {
    ...
    return {
        ...
        provider_regions_text: String(job.provider_regions_text || (((_a = job.providerRegions) === null || _a === void 0 ? void 0 : _a.minimax) ? `稀宇科技 · ${job.providerRegions.minimax === 'cn' ? '国内' : '国际'}` : '')),
        id: jobId,
