...
exports.REFERENCE_UPLOAD_PLATFORM = exports.REFERENCE_UPLOAD_VERSION = void 0;
exports.referenceSubmissionPolicy = referenceSubmissionPolicy;
exports.referenceUploadContract = referenceUploadContract;
exports.activeReferenceUploadPolicy = activeReferenceUploadPolicy;
exports.referenceUploadSelectionError = referenceUploadSelectionError;
exports.referenceModelDimensionsError = referenceModelDimensionsError;
exports.referenceBytesLabel = referenceBytesLabel;
...
exports.REFERENCE_UPLOAD_VERSION = 2;
exports.REFERENCE_UPLOAD_PLATFORM = {
...
function referenceSubmissionPolicy(provider, model, workflow = 'generation') {
    const p = {
...
function referenceUploadContract(platform = exports.REFERENCE_UPLOAD_PLATFORM) {
    return { version: exports.REFERENCE_UPLOAD_VERSION, checkedAt: '2026-09-10', platform };
}
function activeReferenceUploadPolicy(contract, route, workflow = 'generation') {
    const platform = (contract === null || contract === void 0 ? void 0 : contract.version) >= 2 ? { ...exports.REFERENCE_UPLOAD_PLATFORM, ...contract.platform } : {
...
function referenceUploadSelectionError(images, policy) {
...
function referenceModelDimensionsError(image, policy) {
...
function referenceBytesLabel(bytes) { return `${Number((bytes / 1024 / 1024).toFixed(1))}MiB`; }
function referencePolicyHint(policy) {
...
function referenceProcessingHint(policy) {
    if (policy.version < 2)
