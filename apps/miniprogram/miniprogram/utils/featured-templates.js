...
exports.FEATURED_TEMPLATES = exports.FEATURED_TEMPLATE_REFERENCE_IDS = void 0;
exports.featuredTemplateRequest = featuredTemplateRequest;
exports.attachFeaturedTemplateImages = attachFeaturedTemplateImages;
exports.FEATURED_TEMPLATE_REFERENCE_IDS = ['ref_279', 'ref_281', 'ref_245', 'ref_240', 'ref_295', 'ref_10'];
exports.FEATURED_TEMPLATES = [
    {
        id: 'multi-agent-method', sourceReferenceId: 'ref_279', category: 'method_framework', title: '多智能体方法框架',
    ...
    {
        id: 'experiment-reconstruction', sourceReferenceId: 'ref_281', category: 'workflow', title: '实验与重建流程',
    ...
    {
        id: 'molecular-mechanism', sourceReferenceId: 'ref_245', category: 'mechanism', title: '机制与分子通路',
    ...
    {
        id: 'model-architecture', sourceReferenceId: 'ref_240', category: 'system_architecture', title: '模型架构总览',
    ...
    {
        id: 'system-memory', sourceReferenceId: 'ref_295', category: 'system_architecture', title: '系统与记忆架构',
    ...
    {
        id: 'statistical-comparison', sourceReferenceId: 'ref_10', category: 'data_stat', title: '统计对比面板',
...
function featuredTemplateRequest() {
    return { referenceIds: exports.FEATURED_TEMPLATE_REFERENCE_IDS };
}
function attachFeaturedTemplateImages(references) {
    const images = new Map();
    for (const value of references) {
        const item = value && typeof value === 'object' ? value : {};
        const id = typeof item.id === 'string' ? item.id : '';
        const imageUrl = typeof item.imageUrl === 'string' ? item.imageUrl : typeof item.image_url === 'string' ? item.image_url : '';
        if (id)
            images.set(id, imageUrl);
    }
    return exports.FEATURED_TEMPLATES.map((template) => {
        const imageUrl = images.get(template.sourceReferenceId) || '';
        return { ...template, imageUrl, hasImage: Boolean(imageUrl) };
    });
}
