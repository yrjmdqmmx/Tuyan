...
assert.equal(packageJson.version, '3.5.3')
assert.equal(projectConfig.description, '图研Tuyan 3.5.3 微信小程序')
assert.match(sourceConfig, /export const CLIENT_VERSION = 'miniprogram-3\.5\.3'/)
