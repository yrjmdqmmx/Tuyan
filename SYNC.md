...
### [2026-09-16] 参考图按需选择、模型预算与中文失败恢复 — by Codex（本地完成，未发布）
...
- [x] 本地验收：Core 504、Web 393、小程序 119、共享与源契约 51 项通过；类型检查、构建、生成漂移、隔离 Mongo 和浏览器组件验收通过。详见 [修复及验证记录](docs/reference-selection-repair-2026-09-16.md)。
