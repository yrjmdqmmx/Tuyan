...
export interface ProviderJobRecovery { channel: 'tokendance'; canResume: boolean; action: 'top_up_balance' | 'reauthorize_api_key' | 'api_key_quota' | 'rate_limit' | 'retry_request' | 'review_request' | 'resume'; message: string; retryAt?: string; expiresAt?: string }
